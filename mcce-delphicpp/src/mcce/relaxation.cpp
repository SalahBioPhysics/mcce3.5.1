    ...
    */
    ...
    for (i_cycle = 0; i_cycle < env.n_initial_relax; i_cycle++) {
        ...
        for (i_relax=0; i_relax<n_relax; i_relax++) {
            ...
            relax_atoms[i_relax].constr_list = (RELAX_STRUCT**) malloc(relax_atoms[i_relax].n_constr * sizeof(RELAX *));
            ...
            for (i_connect=0; i_connect < n_connect14; i_connect++) {
                ...
                if (j_relax != -1) {
                    ...
                    relax_atoms[i_relax].ngh14 = (RELAX_STRUCT**) realloc(relax_atoms[i_relax].ngh14, relax_atoms[i_relax].n_ngh14*sizeof(RELAX *));
            ...
            for (j_relax =0; j_relax<n_relax; j_relax++) {
                ...
                relax_atoms[i_relax].ngh = (RELAX_STRUCT**) realloc(relax_atoms[i_relax].ngh, relax_atoms[i_relax].n_ngh*sizeof(RELAX *));
...
void relaxation_setup(PROT prot)
{
    ...
    for (ia=0;ia<na;ia++) {
        ...
        all_atoms[ia].constr_list = (RELAX_STRUCT**) malloc(all_atoms[ia].n_constr * sizeof(RELAX *));
        for (i_connect=0; i_connect<n_connect12; i_connect++) {
    ...
    for (i_relax =0; i_relax<n_relax; i_relax++) {
        ...
        if (relax_atoms[i_relax].movable) {
            ...
            for (i_constr=0; i_constr<all_atoms[ia].n_constr; i_constr++) {
                ...
                if (j_relax != -1) {
                    relax_atoms[i_relax].n_constr++;
                    relax_atoms[i_relax].constr_list = (RELAX_STRUCT**) realloc(relax_atoms[i_relax].constr_list, relax_atoms[i_relax].n_constr*sizeof(RELAX *));
